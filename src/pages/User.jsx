...
function User() {
  ...
  // Param var to match user to search
const params = useParams()

// Call func when page loads
useEffect(()=>{
// dispatch loading func when page loads
  dispatch({type:'SET_LOADING'})

  // Get User and Repo Data from Actions file
          ...
          <div className="col-span-2">
            <div className="mb-6">
              ...
              <div className="w-full rounded-lg shadow-md bg-base-100 stats">
                {/* If location is available, showcase */}
                {location && (
                  <div className="stat">
              ...
              {/* If twitter is available, showcase */}
                {twitter_username && (
                  <div className="stat">
